...
class CreateCatOperationTypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::table('cat_operation_types')->insert([
            ...
            ['id' => '0401', 'active' => true, 'exportation' => false, 'description' => 'Ventas no domiciliados que no califican como exportación'],
            ...
            ['id' => '1004', 'active' => true, 'exportation' => false, 'description' => 'Operación Sujeta a Detracción- Servicios de Transporte Carga'],
